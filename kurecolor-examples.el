...
;;
;; Local Variables:
;; eval: (when (fboundp 'rainbow-mode) (rainbow-mode +1)) (font-lock-add-keywords nil '(("(examples\\|(group\\| => \\| ~> " (0 'font-lock-keyword-face))))
;; no-byte-compile: t
;; End:
...
(defalias 'group 'def-example-group)
(defalias 'examples 'defexamples)

(group "Color/hue range grouping"
 (examples kurecolor-hue-group
  (kurecolor-hue-group
    "#00FF00"
    '((group-a (340 . 120))
      (group-b (120 . 240))
...
(group "Utility functions"
 ...
 (examples kurecolor-interpolate
...
(group "CSS helpers"
 (examples kurecolor-hex-to-cssrgb
 ...
 (examples kurecolor-hex-to-cssrgba
 ...
 (examples kurecolor-cssrgb-to-hex
 ...
 (examples kurecolor-css-rgb-value-to-number
...
(group "Absolute set hue, saturation, brightness"
 ...
 (examples kurecolor-hex-set-brightness
...
(group "Set hue, saturation, brightness from another hex color"
 (examples kurecolor-hex-set-brightness-from
 ...
 (examples kurecolor-hex-set-hue-from
 ...
 (examples kurecolor-hex-set-saturation-from
...
(group "RGB Hex to rgb"
 (examples kurecolor-hex-to-rgb
...
(group "RGBA Hex to rgba"
 (examples kurecolor-hex-to-rgba
...
(group "HSV/RGB/HEX (RGB) conversion"
  (examples kurecolor-hex-to-hsv
...
(group "Color adjust"
 ...
 (examples kurecolor-adjust-brightness
...
(group "XCode color literal helpers"
  (examples kurecolor-hex-rgba-to-xcode-color-literal
  ...
  (examples kurecolor-xcode-literal-to-hex-rgba
  ...
  (examples kurecolor-xcode-literal-to-hex-rgb
