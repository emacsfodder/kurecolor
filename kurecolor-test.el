...
(defexamples kurecolor-hex-to-hsv
  ...
  (kurecolor-hex-to-hsv "#729134") => '(0.6413793103448275 0.5686274509803921 0.5555555555555556)
  (kurecolor-hex-to-hsv "#913472") => '(0.5686274509803921 0.5555555555555556 0.6413793103448275))

(defexamples kurecolor-hsv-to-hex
  (kurecolor-hsv-to-hex 0.5555555555555556 0.6413793103448275 0.5686274509803921) => "#347291"
  (kurecolor-hsv-to-hex 0.6413793103448275 0.5686274509803921 0.5555555555555556) => "#729134"
  (kurecolor-hsv-to-hex 0.5686274509803921 0.5555555555555556 0.6413793103448275) => "#913472")

(defexamples kurecolor-rgb-to-hex
  (kurecolor-rgb-to-hex '(0.20392156862745098 0.4470588235294118 0.5686274509803921)) => "#347291")

(defexamples kurecolor-hex-to-hsv
  (kurecolor-hex-to-hsv "#347291") => '(0.5555555555555556 0.6413793103448275 0.5686274509803921))

(defexamples kurecolor-hsv-to-rgb
  (kurecolor-hsv-to-rgb 0.5555555555555556
                        0.6413793103448275
                        0.5686274509803921)
  => '(0.203921568627451
       0.4470588235294117
